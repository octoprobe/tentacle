...
| - | - | - |
| 1-/1+ | 0V/5V | 5d21-ESP32_DEVKIT |
| 2-/2+ | 0V/5V | 472b-ESP32_S3_DEVKIT |
...
Test run: `mptest test --count=3`

Corresponding Testrun: https://reports.octoprobe.org/github_selfhosted_testrun_271/octoprobe_summary_report.html

## Measurements


![Dropping from 4.85 to 4.45V](2025-08-23_voltage-monitoring_images/2025-08-23_voltage-monitoring_a_0_buffer01.png)

![Dropping from 4.8 to 4.4V](2025-08-23_voltage-monitoring_images/2025-08-23_voltage-monitoring_a_0_buffer03.png)
...
|        | 0.025V | 130mA | USB cable, tentacle | |
| 4.805  |        | 130mA | Tentacle USB cable (scrape up PCB) | |
|        | 0.003V | 130mA | MT9700 | |
| 4.802  |        | 130mA | Tentacle PAD GND-5V | |
